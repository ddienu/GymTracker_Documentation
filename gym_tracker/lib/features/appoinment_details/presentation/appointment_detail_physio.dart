...
import 'package:gym_tracker/features/confirmation/presentation/PhysioterapyConfirmation.dart' as physio_confirmation;

class AppointmentDetailPhysiotherapy
...
({super.key});
    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        child: Column(
          ...
          children: [
            // 🔹 CABECERA SUPERIOR (ahora redondeada como en Figma)
            Container(
            ...
            // 🔹 TARJETA PRINCIPAL (cita con entrenador personal)
            Padding(
                            ...
                            child: ElevatedButton(
                              onPressed: () async {
                                ...
                                Navigator.push(
                                  ...
                                  MaterialPageRoute(
                                    builder: (context) =>
                                        const physio_confirmation
                                            .PhysioterapyConfirmation(
                                      isCanceled: true,
                                    ),
                                  ),
                                );
  ...
  // 🔹 Helper para mostrar cada fila de información
