...
class PhysioterapyConfirmation extends StatefulWidget {
  ...
  const PhysioterapyConfirmation({
    super.key,
  ...
  @override
  State<PhysioterapyConfirmation> createState() => _ConfirmationState();
}

// 👇 Renombré la clase interna a _ConfirmationState (mejor práctica)
class _ConfirmationState extends State<PhysioterapyConfirmation> {
      ...
      child: Scaffold(
        body: Stack(
          ...
          children: [
            // Fondo con imagen
            Image.asset(
              'assets/confirmation/FisioterapiaConf.png',
              fit: BoxFit.cover,
            ),
